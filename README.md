...
If you have some new or modified files that has not been committed, it will ask for confirmation whether you want to save and include the changes in this publish command. The tool will also show details of the changes so you can easily decide.
