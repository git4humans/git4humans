...
The infamous [80/20 Pareto Principle](https://en.wikipedia.org/wiki/Pareto_principle) can be found to apply with Git commands. Roughly 80% of your experience with Git will be circling around 20% of the complete commands.

**Git for Humans** is focusing into these 20% commands that you will likely touch in your everyday use. For more complex and advanced use, you can always fallback into the [standard Git commands](https://git-scm.com/docs).
