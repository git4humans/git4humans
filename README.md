...
It will create a new `pytorch` directory for you, and then fetch all data from the pytorch project into the `pytorch` directory. If you want to copy the repository into a different directory, you may specify the name of the target directory as follow: 
