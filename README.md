...
It will create a new `pytorch` directory, and then fetch all data from the repository into the `pytorch` directory. If you want to copy the repository into a different directory, you may specify the name of the directory as follow: 
