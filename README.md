...
If you have some untracked or modified files that has not been committed, it will ask for confirmation whether you want to save and include the changes in your current publish. The tool will also show details of the changes so you can easily decide.
