...
The infamous [80/20 Pareto Principle](https://en.wikipedia.org/wiki/Pareto_principle) can be found to apply with [Git commands](https://git-scm.com/docs). Roughly 80% of your experience with Git will be around 20% of the whole commands.
